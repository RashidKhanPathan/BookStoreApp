...
class FoodBooks extends StatefulWidget {
  const FoodBooks({Key key}) : super(key: key);

  @override
  State<FoodBooks> createState() => _FoodBooksState();
}

class _FoodBooksState extends State<FoodBooks> {
  @override
...
Future<List<Book>> _fetchPotterBooks() async {
  const url = BooksApi.foodBooksApiUrl;
